...
func chapterThree() {
    ...
    print("Lily and Max trailed behind Jake and Mia. Max heard and felt something that made him turn around, but saw nothing but a bush moving.")
    ...
    print("Alex and Max were paralyzed by a surge of fear, gripped by the unimaginable sight before them. This creature was unlike anything they had ever encountered. It possessed the semblance of a colossal wolf, razor-sharp claws and a coat of thick, fur that seemed as sharp as blades.")
