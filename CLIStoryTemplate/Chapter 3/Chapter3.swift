...
func chapterThree() {
   ...
   print("Their bond grew stronger as they delved further into the forest, and their belief in their mission remained unshaken. Each member of the group had a unique skill that proved invaluable: there was Alex, the brilliant strategist; Mia, a skilled archer; Jake, a fearless warrior; Lily, a talented healer; and Max, who possessed a deep connection with nature.")
    print("As their journey unfolded through the dense woods, an eerie symphony of strange sounds began to echo around them. Jake's senses heightened, scanning the surroundings for the source of these unsettling noises, while Mia remained on high alert, her bow poised in readiness, every rustle of leaves triggering her aim.")
    ...
    print("Jake drew his sword, determined to confront the menace. However, his bravery was immediately challenged as the creature leaped towards him, teeth bared and ready to strike.")
    ...
    print("Their cautious advance led them to a glimpse of an enigmatic creature, its form shrouded in uncertainty.")
    print("Straining to discern its true nature, they watched in growing apprehension as it abruptly charged straight at them.")
    print("Mia reacted swiftly, releasing an arrow that narrowly missed its target.")
    print("Mia: Stay back! It's coming right for us!")
    print("In a matter of seconds, the creature lunged at her, throwing her to the ground.")
