...
func chapterThree(){
    ...
    //
    print("Lily and Max trailed behind Jake and Mia. Max heard and felt something that made him turn around, but saw nothing but bush moving.")
 ...
 //MAIN
    ...
    print("Max tried his best to control the creature but for some reason he could get the beast to stop, this was the first creature he encountered that he couldnt control")
